    ...
    <section className="mx-auto max-w-[1440px] px-6 lg:px-12;">
      <div className="flex flex-col sm:flex-row gap-8 mt-8 xl:mt-6">
        ...
        <div className="min-w-60 bg-white p-4 rounded-2xl">
          ...
          <div className="bg-gray-200/30 p-4 ring-1 ring-slate-900/5 mt-6 rounded-xl">
            ...
            <div className="flex flex-col gap-2 font-light">
              {["Men", "Women", "Kids"].map((category) => (
                ...
                >
                  <input onChange={(e)=>toggleFilter(e.target.value, setCategory)} type="checkbox" value={category} className="w-3" />
                  {category}
                </label>
              ))}
            </div>
            ...
            <div className="flex flex-col gap-2 font-light">
              {["Topwear", "Bottomwear", "Winterwear"].map((subCategory) => (
                <label
                  ...
                  className="flex font-medium gap-2 text-gray-500"
                >
                  <input onChange={(e)=>toggleFilter(e.target.value, setSubCategory)} type="checkbox" value={subCategory} className="w-3" />
                  {subCategory}
                </label>
              ))}
            </div>
          ...
          {/* Sort by */}
          <select onChange={(e)=>setSortType(e.target.value)} className="text-[14px] font-medium h-8 w-full border border-slate-500/15 text-gray-500 rounded-lg px-2 outline-none mt-6">
